    ...
    <section class="banner">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <img src="./images/screen-shot-2018-05-29-at-2-03-32-pm-1527617321.png"  width= 400px; height= 550px;  class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="./images/img2.jpg" width= 400px; height= 550px; class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="./images/img4.jpg"  width= 400px; height= 550px; class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="./images/img8.jpg"  width= 400px; height= 550px; class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                <img src="./images/img7.jpg "  width= 400px; height= 550px; class="d-block w-100" alt="...">
                </div>
            </div>
