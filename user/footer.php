...
<link  rel="stylesheet" href="../admin/css/stylesheet_footer1.css">
<footer class="text-muted py-3">
    <div class="container">
        <p class=" float-end mb-2">
        <a href="#" style="text-decoration: none">Back to top</a>
        </p>
        <a class="mb-1" href="index.php"><img src="../admin/images/dioriconwhite.png" alt="" width="179px" height="55px"></a>
    </div>
</footer>
