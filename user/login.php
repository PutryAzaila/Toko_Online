      ...
      <div class="container  ">
        <div class="row content g-0">
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="./images/92f01d925ff174d686f8aa553c638b12.jpg" width= 500px; height= 600px; class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="./images/3af5352464321856f8e39b5de555b620.png"  width= 500px; height= 600px;  class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="./images/diorshow_instagram_1200x1500px.jpg"  width= 500px; height= 600px;  class="d-block w-100" alt="...">
                </div>
              </div>
          ...
          <div class="col-lg-7 px-5 pt-5">
            <div class="mb-3">
              <img src="../admin/images/Dior_Logo_2022.svg.png" alt="" width="35%">
            </div>
