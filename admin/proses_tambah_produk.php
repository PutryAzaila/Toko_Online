<?php
    if($_POST){
        ...
        if($file_size < 2048000 and ($file_type == "image/jpeg" or $file_type== "image/png")){
            ...
            $insert=mysqli_query($koneksi,"insert into produk (nama_produk, deskripsi, kategori, merek, harga, foto_produk) value ('".$nama_produk."', '".$deskripsi."', '".$kategori."', '".$merek."', '".$harga."', '".$file_name."')") or die(mysqli_error($koneksi));
            if($insert){
